  ...
  return (
    <main className={styles.bg}>
      <div className={styles.home}>
        <section className={styles.homeCard} aria-label="CheckInOut">
          ...
          <div className={styles.actionCard} aria-label="ลงเวลา">
            ...
            <button type="button" className={`${styles.btn} ${styles.btnIn}`} onClick={onCheckIn}>
              <span className={styles.btnText}>
                <span className={styles.btnSmall}>กดเข้างาน</span>
            ...
            <button type="button" className={`${styles.btn} ${styles.btnOut}`} onClick={onCheckOut}>
              <span className={styles.btnText}>
                <span className={styles.btnSmall}>กดออกงาน</span>
                <span className={styles.btnSmall} aria-hidden="true">
            ...
            <button type="button" className={styles.history} onClick={onViewHistory}>
